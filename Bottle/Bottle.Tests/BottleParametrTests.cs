...
namespace Bottle.Tests
{
    ...
    public class BottleParameterTests
    {
        [TestCase(24, 80, 20, 22, 130, 
            TestName = "Диаметр основания меньше минимального (35).")]
        [TestCase(30, 66, 20, 22, 130, 
            TestName = "Длина основания меньше минимального (2/3 минимальной длины бутылки = 66.6666).")]
        [TestCase(30, 80, 9, 22, 130, 
            TestName = "Диаметр горлышка меньше минимального (15).")]
